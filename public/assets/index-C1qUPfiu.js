import{r as p,E as _,f as w,e as a,ag as z,o as $,d as l,b as i,Z as y,t as r,a3 as k,v as n}from"./index-6yuKF0Hz.js";import{V as C}from"./VContainer-BzrjVlzn.js";import{V as S}from"./VSpacer-CMoSeckA.js";import{V as B}from"./VTextField-pabjNDbt.js";import{V as N}from"./VCard-CiZ09xQB.js";import{V as T}from"./VDataTable-CF6RQtok.js";import{V as g}from"./VChip-DvEmmi98.js";import{V as A}from"./VSnackbar-DSrmMkKq.js";/* empty css              */import"./VAvatar-Dwc1IZKS.js";import"./VImg-BwKi-q43.js";import"./transition-D1ibqx8u.js";import"./VInput-CxaGp5Mw.js";import"./forwardRefs-D3j0TLhE.js";import"./VCardText-1u3kLCcf.js";import"./VSelect-DeOwJRbv.js";import"./VList-qaq0yeUt.js";import"./VDivider-C9O02X4u.js";import"./dialog-transition-B1C-E504.js";import"./VMenu-C_840DDo.js";import"./VOverlay-C0mXXD8E.js";import"./VSelectionControl-B0bAruls.js";import"./VTable-32jSoSNv.js";import"./filter-C6Pj00zR.js";const D={class:"d-flex align-center gap-3 mb-4"},F={class:"font-weight-bold font-monospace"},P={class:"d-flex gap-1 justify-end"},j={class:"text-center py-8 text-medium-emphasis"},st={__name:"index",setup(E){const c=p([]),u=p(!1),f=p(""),d=p({show:!1,color:"success",msg:""}),b=[{title:"N°",key:"numero"},{title:"Fecha",key:"fecha"},{title:"Documento",key:"tipo"},{title:"Cliente",key:"cliente"},{title:"Piezas",key:"total_piezas"},{title:"",key:"acciones",sortable:!1,align:"end"}];async function h(){u.value=!0;try{const{data:e}=await z.get("/api/ordenes-corte",{params:{buscar:f.value||void 0}});c.value=Array.isArray(e)?e:[]}catch{c.value=[]}finally{u.value=!1}}function V(e){const o=(e.piezas||[]).map((m,v)=>`
    <tr>
