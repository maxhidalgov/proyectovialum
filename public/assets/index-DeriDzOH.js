import{r as p,E as _,f as w,e as a,ag as z,o as $,d as l,b as i,Z as y,t as r,a3 as k,v as n}from"./index-DGbc2PzN.js";import{V as C}from"./VContainer-B80b-oCc.js";import{V as S}from"./VSpacer-oqotDWUX.js";import{V as B}from"./VTextField-Dit9unTX.js";import{V as N}from"./VCard-Cvzd9kBr.js";import{V as T}from"./VDataTable-cQXY_DSA.js";import{V as g}from"./VChip-Bkri8RvH.js";import{V as A}from"./VSnackbar-C4KriMQb.js";/* empty css              */import"./VAvatar-B27LMaJO.js";import"./VImg-DaD2aaRp.js";import"./transition-DP0fNQM5.js";import"./VInput--aU3bCpn.js";import"./forwardRefs-D3j0TLhE.js";import"./VCardText-CG0phKyr.js";import"./VSelect-B7B-u7LR.js";import"./VList-DFj166oN.js";import"./VDivider-DaqWhjiZ.js";import"./dialog-transition-CRdZQXSS.js";import"./VMenu-BCb5gL2u.js";import"./VOverlay-D1C_mfh4.js";import"./VSelectionControl-CmCYvzO7.js";import"./VTable-COenIu2U.js";import"./filter-Cm6U_AuZ.js";const D={class:"d-flex align-center gap-3 mb-4"},F={class:"font-weight-bold font-monospace"},P={class:"d-flex gap-1 justify-end"},j={class:"text-center py-8 text-medium-emphasis"},st={__name:"index",setup(E){const c=p([]),u=p(!1),f=p(""),d=p({show:!1,color:"success",msg:""}),b=[{title:"N°",key:"numero"},{title:"Fecha",key:"fecha"},{title:"Documento",key:"tipo"},{title:"Cliente",key:"cliente"},{title:"Piezas",key:"total_piezas"},{title:"",key:"acciones",sortable:!1,align:"end"}];async function h(){u.value=!0;try{const{data:e}=await z.get("/api/ordenes-corte",{params:{buscar:f.value||void 0}});c.value=Array.isArray(e)?e:[]}catch{c.value=[]}finally{u.value=!1}}function V(e){const o=(e.piezas||[]).map((m,v)=>`
    <tr>
