      ...
      <div v-for="(ventana, index) in cotizacion.ventanas" :key="index" class="mb-4">
        <v-card class="pa-4" outlined>
          <v-row dense>
            ...
            <v-row v-if="ventana.tipo === 47">
              <v-col cols="4">
                <v-text-field v-model="ventana.ancho_izquierda" label="Ancho izquierda (mm)" type="number" />
              </v-col>
              <v-col cols="4">
                <v-text-field v-model="ventana.ancho_centro" label="Ancho centro (mm)" type="number" />
              </v-col>
              <v-col cols="4">
                <v-text-field v-model="ventana.ancho_derecha" label="Ancho derecha (mm)" type="number" />
              </v-col>
            </v-row>

                          
              <!-- Selector: ¿Ventana compuesta? -->
              ...
              <!-- Selector: ¿Ventana derecha compuesta? -->
              <template v-if="ventana.tipo === 47">
                <v-col cols="12">
                  <v-switch
            ...
            <template v-if="ventana.tipo === 47">
              ...
              <v-row dense>
                <template v-if="ventana.tipoVentanaIzquierda.compuesta">
                  <v-col cols="12"><h4>Ventana izquierda compuesta</h4></v-col>
                  ...
                  <v-col cols="12" sm="6">
                    ...
                    />
                    <v-text-field
                      v-model="ventana.tipoVentanaIzquierda.partes[0].alto"
                      label="Alto (mm)"
                      type="number"
                      outlined
                      dense
                  ...
                  <v-col cols="12" sm="6">
                    ...
                    />
                    <v-text-field
                      v-model="ventana.tipoVentanaIzquierda.partes[1].alto"
                      label="Alto (mm)"
                      type="number"
                      outlined
                      dense
                ...
                <template v-if="ventana.tipoVentanaCentro && [3, 46].includes(ventana.tipoVentanaCentro.tipo)">
                  ...
                  <v-col cols="6" sm="3">
                    <v-select
                      ...
                      :rules="[v => !v || v <= ventana.tipoVentanaCentro.hojas_totales || 'No puede exceder total']"
                      outlined
                      color="primary"
                    />
                  </v-col>

                  <v-col cols="12" sm="6" v-if="ventana.tipoVentanaCentro.hojas_moviles === 1">
                    <v-radio-group
              ...
              <v-row dense>
                <template v-if="ventana.tipoVentanaDerecha.compuesta">
                  <v-col cols="12"><h4>Ventana derecha compuesta</h4></v-col>
                  ...
                  <v-col cols="12" sm="6">
                    ...
                    />
                    <v-text-field
                      v-model="ventana.tipoVentanaDerecha.partes[0].alto"
                      label="Alto (mm)"
                      type="number"
                      outlined
                      dense
                  ...
                  <v-col cols="12" sm="6">
                    ...
                    />
                    <v-text-field
                      v-model="ventana.tipoVentanaDerecha.partes[1].alto"
                      label="Alto (mm)"
                      type="number"
                      outlined
                      dense
            ...
            <!-- === CORREDERA SIMPLE (no bay window) === -->
            <template v-if="[3, 46].includes(ventana.tipo)">
              <v-row dense>
                <v-col cols="6" sm="3">
                  <v-select
